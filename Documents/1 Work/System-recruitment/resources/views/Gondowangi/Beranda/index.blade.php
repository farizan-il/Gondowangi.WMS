...
<head>
    ...
    <style>
        ...
        .expired-event .card-top {
            background-color: rgb(132, 127, 127)!important;
        }
        ...
        @media (max-width: 575.98px) {
            ...
            /* Statistics in hero - stack vertically on mobile */
            ...
            .position-absolute.top-0.end-0 .d-flex > div {
                display: flex;
                flex-direction: column;
                align-items: center;
                text-align: center;
            ...
            .header-news .position-absolute.bottom-0 p {
                width: 100% !important;
            }
        ...
        @media (min-width: 768px) and (max-width: 991.98px) {
            ...
            /* Events section carousel adjustments */
            .col-md-3 {
                flex: 0 0 50%;
                max-width: 50%;
            }
            
            /* News section - stack smaller news items */
            .col-4 {
                flex: 0 0 33.333333%;
                max-width: 33.333333%;
            }
        ...
        @media (max-width: 480px) {
            ...
            /* Awards section title adjustments */
            .awards-section h2 {
                font-size: 1.8rem;
            }
