...
@section('content')
        ...
        <div class="align-items-center  pt-5">
            <div class="row">
                <div class="col-lg-7 fade-in-left"
                    style="background-image: url('{{ $bannerBrand && $bannerBrand->img ? asset($bannerBrand->img) : 'https://png.pngtree.com/png-clipart/20210523/original/pngtree-image-file-icon-that-is-damaged-or-corrupted-png-image_6315903.png' }}'); height: 100vh; background-size: cover; background-repeat: no-repeat;">
                </div>


                <div class="col-lg-5 d-flex flex-column text-center justify-content-center align-items-center bg-dark fade-in-right">
                    <h2 style="font-size: 40px; color: #ffc603;" class="fade-in-left fw-bold">
                        {{ optional($bannerBrand)->brand_name ?? 'Brand Name Default' }}
                    </h2>
                    <h6 class="fade-in-left p-3" style="font-size: 23px; transition-delay: 0.2s;">
                        {{ optional($bannerBrand)->deksripsi ?? 'Deskripsi belum tersedia.' }}
                    </h6>
                </div>
            </div>
        </div>
    ...
    <section class="natural-product mt-0 pt-0" style="background-image: url(assets/background-all-brand.png);">
        <div class="container">
            <h2 class="section-title pt-5">Our Natural Product</h2>
                    ...
                    @foreach($detailBrands as $index => $product)
                        <div class="product-card" style="--delay: {{ $index * 0.1 }}s">
                            ...
                            <div class="product-info my-auto">
                                <h3>{{ $product->brand_name }} {{ $product->type }}</h3>
