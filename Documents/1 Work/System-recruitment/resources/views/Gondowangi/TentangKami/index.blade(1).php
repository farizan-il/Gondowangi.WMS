                ...
                <div class="col-12 mt-5">
                    <div class="timeline-wrapper position-relative">
                        ...
                        <div class="timeline-carousel d-flex overflow-hidden" id="timeline">
                            <!-- Timeline Item -->
                            <div class="timeline-item flex-shrink-0 px-2" data-year="1970">
                                <div class="timeline-year">1970</div>
                                <div class="timeline-dot"></div>
                                <div class="timeline-card">
                                    <h5>Awal Mula</h5>
                                    <p>Mulanya pak liem melakukan bisnis budidaya rumput laut. Pada saat itu beliau mengetahui bahwa bahan baku rumput laut yang beliau ekspor ke Perancis merupakan bagian dari komposisi aktif yang digunakan sebagai kosmetik, lalu ide pun muncul untuk membuat produk krim alas bedak dari bahan tersebut.</p>
                                </div>
                            </div>
                            <!-- /Item -->

                            <!-- Copy & sesuaikan untuk setiap milestone -->
                            <div class="timeline-item flex-shrink-0 px-2" data-year="1977">
                                <div class="timeline-year">1977</div>
                                <div class="timeline-dot"></div>
                                <div class="timeline-card">
                                    <h5>Penelitian dan Observasi</h5>
                                    <p>Setelah melalui berbagai proses penelitian dan percobaan pak Liem meluncurkan pencuci rambut berbahan jamu pertama kali dengan merek Natur yang berarti alam dalam bahasa Perancis. </p>
                                    
                                </div>
                            </div>

                            <div class="timeline-item flex-shrink-0 px-2" data-year="2000">
                                <div class="timeline-year">2000</div>
                                <div class="timeline-dot"></div>
                                <div class="timeline-card">
                                    <h5>Momentum Ekspansi</h5>
                                    <p>Menjadi momen besar bagi Gondowangi dengan menambah kapasisas produksi yang berstandar sesuai cara produksi kosmetika yang baik dan kemampuan produksi produk-produk perawatan pribadi lainnya. Tidak hanya itu, di saat yang sama membentuk divisi pemasaran yang profesional.</p>
                                    
                                </div>
                            </div>

                            <!-- Timeline Item -->
                            <div class="timeline-item flex-shrink-0 px-2" data-year="2001">
                                <div class="timeline-year">1970</div>
                                <div class="timeline-dot"></div>
                                <div class="timeline-card">
                                    <h5>Awal Mula</h5>
                                    <p>Mulanya pak liem melakukan bisnis budidaya rumput laut...</p>
                                </div>
                            </div>
                            <!-- /Item -->

                            <!-- Copy & sesuaikan untuk setiap milestone -->
                            <div class="timeline-item flex-shrink-0 px-2" data-year="2005">
                                <div class="timeline-year">1977</div>
                                <div class="timeline-dot"></div>
                                <div class="timeline-card">
                                    <h5>Penelitian dan Observasi</h5>
                                    <p>Setelah melalui berbagai proses penelitian...</p>
                            ...
                            <div class="timeline-item flex-shrink-0 px-2" data-year="2010">
                                <div class="timeline-year">2000</div>
                                <div class="timeline-dot"></div>
                                <div class="timeline-card">
                                    <h5>Momentum Ekspansi</h5>
                                    <p>Menjadi momen besar bagi Gondowangi dengan...</p>
                                    <div class="position-relative card-news-hover-overlay">
            ...
            <div class="modal-content">
                ...
                <div class="product-details">
                    ...
                    <div class="product-details-info">
                        ...
                        <button class="btn pulsing">Beli Sekarang</button>
                    </div>
                </div>
            </div>
        </div>
