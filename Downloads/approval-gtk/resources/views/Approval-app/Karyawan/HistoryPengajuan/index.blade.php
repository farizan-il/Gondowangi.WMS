                                ...
                                <td>
                                    @php
                                        ...
                                        $statusText = match($pengajuan->status_pengajuan) {
                                            ...
                                            'settlement_created' => 'Proses Settlmenet',
                                            default => '-'
                                        };
                                    @endphp
...
@section('script')
    ...
    <script>
        ...
        function renderPerjalananDinasDetail(detailFields, hotelMakanData = null) {
            ...
            const totalPerjalanan1 = transportasiDarat1 + transportasiTaxi1 + hotelBiaya1 + makanBiaya1 + uangSaku1 + telephoneFax1 + entertainment1 + dokumentasi1 + lainLain1;
            const totalPerjalanan2 = transportasiDarat2 + transportasiTaxi2 + hotelBiaya2 + makanBiaya2 + uangSaku2 + telephoneFax2 + entertainment2 + dokumentasi2 + lainLain2;
            const totalPerjalanan3 = transportasiDarat3 + transportasiTaxi3 + hotelBiaya3 + makanBiaya3 + uangSaku3 + telephoneFax3 + entertainment3 + dokumentasi3 + lainLain3;
