        ...
        <div class="admin-card financial-summary">
            <div class="row">
                <div class="col-md-3 financial-item border-end" 
                    ...
                    <div class="financial-amount">Rp {{ number_format($financialSummary['total_budget_requested'], 1, ',', '.') }}</div>
                ...
                <div class="col-md-3 financial-item border-end" 
                    ...
                    <div class="financial-amount"><i class="fas fa-check-circle me-2 text-success"></i>
                        Rp {{ number_format($financialSummary['total_budget_approved'], 1, ',', '.') }}</div>
